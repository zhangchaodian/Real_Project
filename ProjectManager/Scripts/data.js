var ganttData = [
	{
		id: 1, name: "Feature 1", series: [
			{ name: "Planned", start: new Date(2015,05,01), end: new Date(2015,05,03) },
			{ name: "Actual", start: new Date(2015,05,02), end: new Date(2015,05,05), color: "#f0f0f0" }
		]
	}, 
	{
		id: 2, name: "Feature 2", series: [
			{ name: "Planned", start: new Date(2015,05,05), end: new Date(2015,05,20) },
			{ name: "Actual", start: new Date(2015,05,06), end: new Date(2015,05,17), color: "#f0f0f0" },
		]
	...
	// 		{ name: "Planned", start: new Date(2010,01,01), end: new Date(2010,01,03) },
	// 		{ name: "Actual", start: new Date(2010,01,01), end: new Date(2010,01,08), color: "#f0f0f0" }
	// 	]
	// }
];